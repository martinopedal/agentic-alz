...
variable "client_source_ip_group_ids" {
  type        = list(string)
  description = "Resource ids of azurerm_ip_group resources covering the client subnets that need DNS resolution for Private Endpoints."
...
variable "name" {
  ...
  default     = "allow-storage-private-endpoint-resolution"
